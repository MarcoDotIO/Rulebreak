...
| `--signal` | `#4A9B8C` | Fixed-control / `blocked_as_expected` **only** — never a “secure” badge |
...
- Copper **left spine** on finding detail when a finding exists
- Timeline may keep sequence numbers (`#n`)
