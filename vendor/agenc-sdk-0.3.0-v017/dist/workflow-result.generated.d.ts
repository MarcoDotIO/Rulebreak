...
export declare const AGENC_WORKFLOW_RESULT_VERSION: 2;
export declare const AGENC_WORKFLOW_STEP_OUTCOMES_V2: readonly ["succeeded", "failed", "cancelled", "unknown_outcome", "handoff_failed", "blocked_dependency_failed", "blocked_dependency_unknown"];
export declare const AGENC_WORKFLOW_RUN_OUTCOMES_V2: readonly ["completed", "failed", "cancelled", "unknown_outcome"];
export declare const AGENC_WORKFLOW_CANCELLATION_CAUSES: readonly ["user_abort", "workflow_deadline", "daemon_shutdown", "fail_fast_peer"];
export declare const AGENC_DEFAULT_WORKFLOW_MAX_CONCURRENCY: 16;
export declare const AGENC_MAX_WORKFLOW_MAX_CONCURRENCY: 64;
export declare const AGENC_DEFAULT_WORKFLOW_MAX_HANDOFF_TOKENS: 8192;
export declare const AGENC_MAX_WORKFLOW_HANDOFF_TOKENS: 32768;
export declare const AGENC_MAX_WORKFLOW_FINAL_RESPONSE_BYTES: 4194304;
export type WorkflowStepOutcomeV2 = (typeof AGENC_WORKFLOW_STEP_OUTCOMES_V2)[number];
export type WorkflowGroupOutcomeV2 = WorkflowStepOutcomeV2;
export type WorkflowRunOutcomeV2 = (typeof AGENC_WORKFLOW_RUN_OUTCOMES_V2)[number];
export type WorkflowCancellationCause = (typeof AGENC_WORKFLOW_CANCELLATION_CAUSES)[number];
...
//# sourceMappingURL=workflow-result.generated.d.ts.map