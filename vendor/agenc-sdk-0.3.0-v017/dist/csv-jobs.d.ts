 ...
 */
export declare const AGENC_SDK_CSV_JOB_CONTRACT_VERSION: 1;
export declare const AGENC_SDK_CSV_OUTPUT_CONTRACT_VERSION: 1;
export declare const AGENC_SDK_CSV_AGENT_JOB_STATUSES: readonly ["pending", "running", "completed", "failed", "cancelled", "needs_review", "finished_with_unknown_outcomes"];
export declare const AGENC_SDK_CSV_AGENT_JOB_ITEM_STATUSES: readonly ["pending", "running", "completed", "failed", "cancelled", "unknown_outcome"];
export declare const AGENC_SDK_CSV_RESULT_AVAILABILITIES: readonly ["not_produced", "available", "unavailable_after_review"];
export type CsvAgentJobStatus = (typeof AGENC_SDK_CSV_AGENT_JOB_STATUSES)[number];
export type CsvAgentJobItemStatus = (typeof AGENC_SDK_CSV_AGENT_JOB_ITEM_STATUSES)[number];
export type CsvResultAvailability = (typeof AGENC_SDK_CSV_RESULT_AVAILABILITIES)[number];
...
export type CsvReviewDisposition = "confirmed_committed" | "confirmed_no_effect" | "remains_unknown";
export type CsvReviewDomainAction = "mark_completed" | "retry_new_attempt" | "abandon_item";
...
//# sourceMappingURL=csv-jobs.d.ts.map